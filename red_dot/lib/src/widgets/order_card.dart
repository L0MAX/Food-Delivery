      ...
      child: Padding(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/images/jollof.png"),
                fit:  BoxFit.cover,
              ),
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Text("Ghana Jollof", style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold),),
              SizedBox(height: 5.0,),
              Text(
                "\u023b 3.0", style: TextStyle(color: Colors.orangeAccent, fontSize: 16.0,),),
              SizedBox(height: 5.0,),
              Container(
                height: 25.0,
                width: 120.0,
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text("Salad", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold,),),
                        SizedBox(width: 5.0,),
                        InkWell(
                          onTap: (){},
                          child: Text("x", 
